...
public class PayloadFactory {
	...
	static {
		...
		payloadRegistry.put(ActionChoiceConstant.EMPLOYEE_VIEW_CHEF_RECOMMENDATION,
				"com.payload.ChefRecommendPayloadHelper");
		...
		payloadRegistry.put(ActionChoiceConstant.CHEF_VIEW_DISCARD_MENU_ITEM_LIST,
				"com.payload.DiscardItemPayloadHelper");
	...
	public static <T> Payload<T> getInstance(String userActionChoice, Hashtable<String, Object> userInput)
		...
		if (className == null || className == "") {
			throw new InvalidOperationException(ErrorMessageConstant.NO_PAYLOAD_FOUND + " : " + userActionChoice);
		}
