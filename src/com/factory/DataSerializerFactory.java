...
public class DataSerializerFactory {
	...
	public static DataSerializer getInstance(String protocolFormat)
			throws DataSerializationException, ClassNotFoundException, NoSuchMethodException, SecurityException,
